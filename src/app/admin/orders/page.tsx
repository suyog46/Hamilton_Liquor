...
export default function AdminOrdersPage() {
  ...
  return (
    <div className="flex flex-col gap-4">
      <AdminPageHeader
        title="Orders"
        description="Review and fulfill pickup and delivery orders."
      />
      {isError ? (
                ...
                <TableRow key={order.id}>
                  <TableCell>
                    <div className="flex flex-col gap-1.5">
                      <Link
                        ...
                        className="font-semibold hover:text-primary-active"
                      >
                  ...
                  <TableCell className="text-right">
                    <Link
                      ...
                      className="inline-flex size-8 items-center justify-center hover:text-primary-active"
                    >
                      <Icon
