...
const highlights = [
  {
    ...
    description:
      "Wine, spirits, beer, and mixers hand-picked by staff who know the shelves inside and out.",
  },
  {
    icon: "solar:users-group-rounded-linear",
    title: "Knowledgeable Staff",
    description:
      "Ask us for a pairing, a gift recommendation, or a new bottle to try — we're happy to help.",
  },
  {
    icon: "solar:bag-check-outline",
    title: "Fast Pickup",
    description:
      "Order online and pick up in-store, usually ready within 30–60 minutes.",
  },
  {
    icon: "solar:map-point-linear",
    title: "Proud Local Shop",
    description:
      "Serving the Hamilton neighborhood on Harford Road for the Baltimore community.",
  },
];
      ...
      <section className="bg-white py-14 sm:py-20">
        <div className="max-w-[1280px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div className="flex flex-col gap-5">
            <span className="text-xs font-semibold uppercase tracking-widest text-primary-normal">
              Who We Are
            </span>
            ...
            <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
              {siteConfig.name} has been part of the Hamilton neighborhood,
              stocking shelves with everything from everyday favorites to
              hard-to-find bottles. We built our online store to make browsing,
              ordering, and picking up your favorites as easy as walking down
              the aisle.
            </p>
            <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
              From weekly specials to staff picks, we take pride in helping
              every customer find the right bottle for the occasion — whether
              that&apos;s a weeknight six-pack or a bottle worth celebrating.
            </p>
        ...
        <div className="max-w-[1280px] mx-auto px-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {highlights.map((item) => (
              <div
                key={item.title}
                className="flex flex-col gap-3 p-6 rounded-2xl bg-white border border-gray-100 shadow-sm"
              >
                ...
                <h3 className="font-title text-base font-semibold text-black">
                  {item.title}
                </h3>
