...
// Reusable parent for the inventory landing page: owns the query params
// and talks to the same `getProducts` endpoint as ProductsTable, but
// renders inventory-focused columns (per-variant stock + adjust/history
// actions) via the same core DataTable/DataTablePagination.
export function InventoryTable({ search }: InventoryTableProps) {
    ...
    return (
      <Card>
        <CardContent className="flex flex-col items-center gap-2 py-8 text-center">
          ...
          <p className="text-xs text-muted-foreground">Failed to load inventory.</p>
        </CardContent>
      </Card>
    );
  }
