...
const MaintenanceNotice = () => (
  <Dialog open>
    <DialogContent
      ...
      className="w-[calc(100%-2rem)] max-w-md rounded-2xl border border-white/30 bg-white p-7 text-center text-black shadow-2xl sm:p-9"
    >
      ...
      <DialogHeader className="items-center gap-2 text-center">
        <DialogTitle className="font-title text-2xl font-semibold text-black">
          Site Under Maintenance
        </DialogTitle>
        <DialogDescription className="max-w-sm text-sm leading-6 text-black/70">
